...
/** Register the History Management configuration panel (recurring prompt settings).
 * Scribe/HistoryScribe was removed — superseded by /auto worker system.
 * @param {ConfigPane} pane - The ConfigPane instance to register schemas on.
 */
export function registerHistorySchemas(pane: ConfigPane): void {
  ...
  // Simple detail config — toggles rendered as toggle, text as text
