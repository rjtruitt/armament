...
import { getSessionCommands, getIrcCommands, getConfigCommands, getContextCommands, getFlowCommands, getSetrootCommand, getNudgeCommands, getGodModeCommand } from './commands/index.js';
